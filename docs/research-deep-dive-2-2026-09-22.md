...
- [前期核查文档：fal vs RunComfy 分发通道（本地 video-ai-landscape 仓库）](https://video-vendor-skills.pages.dev/docs/research-vendor-next-moves-2026-09-22.html)
...
- [[本地] higgsfield-generate SKILL.md（CLI 阻塞式异步、UX 规则、NOT-for 路由）](https://video-vendor-skills.pages.dev/skills/higgsfield-skills/higgsfield-generate/SKILL.html)
- [[本地] higgsfield troubleshooting.md（按报错字符串 playbook、cost 子命令）](https://video-vendor-skills.pages.dev/skills/higgsfield-skills/higgsfield-generate/references/troubleshooting.html)
- [[本地] higgsfield evals/README.md（prose 回归测试哲学）](https://video-vendor-skills.pages.dev/skills/higgsfield-skills/evals/README.html)
- [[本地] atlascloud universal-video-prompt-skill references/execution.md（计费任务状态机、凭证作用域、恢复协议）](https://video-vendor-skills.pages.dev/skills/atlascloud-skills/skills/universal-video-prompt-skill/references/execution.html)
- [[本地] atlascloud seedance-2-5-skill SKILL.md（execution resumePredictionIds、2s 轮询间隔）](https://video-vendor-skills.pages.dev/skills/atlascloud-skills/skills/seedance-2-5-skill/SKILL.html)
- [[本地] atlascloud atlas-cloud SKILL.md（GET 指数退避/POST 禁重试防重复扣费）](https://video-vendor-skills.pages.dev/skills/atlascloud-skills/atlas-cloud/SKILL.html)
- [[本地] runwayml runway-dev SKILL.md（基座+表面技能、llms.txt 时效阶梯、SDK wait helper、错误映射表）](https://video-vendor-skills.pages.dev/skills/runwayml-skills/skills/runway-dev/SKILL.html)
- [[本地] runwayml rw-generate-video SKILL.md（每模型 credit 表）](https://video-vendor-skills.pages.dev/skills/runwayml-skills/skills/rw-generate-video/SKILL.html)
- [[本地] runwayml rw-check-org-details SKILL.md（credit 余额/限额/美元换算）](https://video-vendor-skills.pages.dev/skills/runwayml-skills/skills/rw-check-org-details/SKILL.html)
- [[本地] fal genmedia SKILL.md（agent-first CLI、--json 纪律、async+poll 模式）](https://video-vendor-skills.pages.dev/skills/fal-community-skills/skills/genmedia/SKILL.html)
- [[本地] fal fal-gamedev SKILL.md（并行 async 发射+串行轮询、400 still-in-progress 语义）](https://video-vendor-skills.pages.dev/skills/fal-community-skills/skills/fal-gamedev/SKILL.html)
- [[本地] fal model-routing SKILL.md（数据技能+endpoint 验证阶梯）](https://video-vendor-skills.pages.dev/skills/fal-community-skills/skills/model-routing/SKILL.html)
- [[本地] anthropics skill-creator SKILL.md（官方规范：渐进披露、pushy description、scripts/references/assets 结构）](https://video-vendor-skills.pages.dev/skills/anthropics-skills/skills/skill-creator/SKILL.html)
- [[本地] anthropics spec 指针（官方规范迁至 agentskills.io）](https://video-vendor-skills.pages.dev/skills/anthropics-skills/spec/agent-skills-spec.html)
- [[本地] elevenlabs setup-api-key SKILL.md（凭证技能：先验证后安装、key 不回显）](https://video-vendor-skills.pages.dev/skills/elevenlabs-plugin/skills/general/setup-api-key/SKILL.html)
- [[本地] runway-mcp-plugin runway-media SKILL.md（MCP 包装模式、rough cost 确认规则）](https://video-vendor-skills.pages.dev/skills/runway-mcp-plugin/skills/runway-media/SKILL.html)
